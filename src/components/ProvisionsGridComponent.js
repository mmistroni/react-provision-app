...
import '../App.css';
import {PROVISIONS_COLUMNDEFS, PROVISIONS_ROWDATA, INSERT_URL} from '../resources/grid-data.js';
...
class SharesRenderGrid extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columnDefs: PROVISIONS_COLUMNDEFS,
      test: 'passing props',
      sideBar: {
        toolPanels: [
          {
...
export default SharesRenderGrid;
